...
export function useLoading(props: Partial<LoadingProps>): [Fn, Fn, (str: string) => void]
export function useLoading(opt: Partial<UseLoadingOptions>): [Fn, Fn, (str: string) => void]
