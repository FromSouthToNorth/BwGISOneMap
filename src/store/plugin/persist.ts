 ...
 * @Date: 2024-02-21 19:48:48
 * @LastEditors: huangyu 598050554@qq.com
 * @LastEditTime: 2024-03-05 14:40:57
 * @FilePath: \BwGISOneMap\src\store\plugin\persist.ts
...
export const PERSIST_KEY_PREFIX = 'BW_'
...
export function createPersistedStateOptions(keyPrefix: string): PersistedStateFactoryOptions {
  return {
    ...
    serializer: customSerializer(true),
  }
}
